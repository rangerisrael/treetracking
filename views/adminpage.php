...
#
  ...
  echo "<script>
        alert('ACCESS DENIED');
        window.location.href=('mainpage.php?=access denied');
      </script>";
        }
...
coordinates='';
    ...
    marker.bindPopup( "<img   style='position:relative; left:1vw;width:280px;height:150px;'src='map/gps/" + companies[i]['species_profile'] + "' />"+
