...
<div class="w3-green">
  ...
  <form action="updatingmarkerpoint.php" method="post" enctype="multipart/form-data">
...
<input id="profile"   type="file" name="profile"  onchange="PreviewImage();"   accept="image/*" >
Browse Image
</label><br><br><br>
...
<label for="areaname" id="arealabel">Species</label>
    ...
    <?php for($i=0; $i < count($arr); $i++) { print '<option value="'.$arr[$i]['z'].'">'.$arr[$i]['species_name'].'</option>'; } ?>
    </select>
...
<input type="date" name="date" id="date" required="" oninvalid="this.setCustomValidity('date is missing')" oninput="this.setCustomValidity('')"><br><br>
  ...
  <br>
  <input type="number" name="theight" id="theight" placeholder="       TREE HEIGHT" required="" oninvalid="this.setCustomValidity('tree height is not define')" oninput="this.setCustomValidity('')">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<input type="submit" name="insert" id="insert" class="w3-red" style="position:relative;top:-25vh;left:5vw;" value="UPDATE">
  </form>
