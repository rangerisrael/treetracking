...
?>
	...
	if(strlen($_SESSION['user']['name']) >=6){
		...
		echo "<p style='color:white;  position:absolute; top:20vh; left:7vw;  font-family:'Comics Sans MS',cursive, san-serif;'>";
		echo ucwords($_SESSION['user']['name']);
		echo "</p>";
	}
	...
	?>
      ...
      <div class="dropdown">
        <br>
			...
			<i  class=""></i></button>
                ...
                <li><a style="color:black;font-weight: bold;" href="../addingdatastaff.php">ADD TREE</a></li>
                <li><a style="color:black;font-weight: bold;"href="../showdatastaff.php">MODIFY TREE</a></li>
      ...
      <li><a style="color: black;font-weight: bold;" href="../modifyposts.php">MANAGE YOUR POST</a></li>
      <li><a style="color: black;font-weight: bold;" href="../modifypostsall.php">MANAGE ALL POST</a></li>                  
      <li><a style="color:black;font-weight: bold;" href="../manage_announcement.php">MANAGE ANNOUNCEMENT</a></li>
      <li><a style="color:black;font-weight: bold;" href="../manage_announcementall.php">MANAGE ALL ANNOUNCEMENT</a></li>
...
<div class="dropup">    <br>
  <a href="staffshowmap.php"><img class="m1" src="../background/icon/btn4.gif" style="position:relative; top:  cursor:pointer; left:0vw; padding: 10px;" width="100%" height="70"/></a>
