...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none; font-weight: bold;" id="mySidebar">
  ...
  <a href="addarea.php" class="w3-bar-item w3-button">UPDATE PLATATION AREA</a>
...
<div class="w3-green">
  ...
  <form action="updatingarea.php" method="post">
  ...
  <input type="submit" class="w3-red" style="position:relative; left:7vw;" value="UPDATE">
  </form>
...
<script>
     ...
     for(var i=0;i<arr.length;i++) {
      if(arr[i]['area_id'] == $('#area').val()) {
       $('#geo').val(arr[i]['geopoint']);
       $('#hectare').val(arr[i]['sizeofland']);
