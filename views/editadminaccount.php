		...
		if(isset($_POST['update']))

			{
				...
				if (empty($_FILES["profile"]["name"])){
						...
						$stmt=$db_conn->prepare('update security SET username=:user,nameofuser=:roles,profile=:uprofile,role_type=:usertype,date_updated=NOW() WHERE id=:ids');
					...
					<script type="text/javascript">
						...
						window.location.href="modifiesadmin.php";
					</script>
					<?php 
...
<script type="text/javascript">
	...
	document.getElementById("uploadPreview").src = oFREvent.target.result;
	 ...
	 <?php  
	   include("../models/config.php");
	  		$stmt=$db_conn->prepare("SELECT * FROM security where id=:id");
	  		$stmt->execute(array(
      ...
      echo "<img id='uploadPreview'   style=' border:inset 5px  #FFCC66; margin-left:0.5vw;width:18.5vw; position:relative; top:-1vh; height:25vh;' src='profile/".$row['profile']."'  >";
    
    ?>
      <input id="uploadImage" style="position:relative; top:-1.8vw;left:21.3vw; " type="file" name="profile"  onchange="PreviewImage();"   accept="image/*"  value="profile/".$row['profile']."" ></br>
								

				
				<input type="text" name="username" class="user" placeholder="USERNAME" required="" oninvalid="this.setCustomValidity('USERNAME IS IMPORTANT')" oninput="this.setCustomValidity('')" value="<?php echo $row['username']; ?>">   
				
       <br><br>
				<input type="text" name="role" class="role" placeholder="NAME OF USER" requied="" oninvalid="this.setCustomValidity('NAME OF USER IS REQUIRED')" maxlenngth"15" oninput="this.setCustomValidity('')" value="<?php echo $row['nameofuser'];?>">
			<select name="user_role" class="user" value="<?php echo $row['role_type']?>" selected style="position:relative; top:4vh; left:8vw;">
                <option value="<?php echo $row['role_type']?>" disabled><?php echo $row['role_type']?></option>
                <option value="ADMIN">ADMIN</option> 
                <option value="STAFF">STAFF</option> 

        </select>
<br>		
        <button type="submit" style="position:relative; left:16vw; top:8vh;"  class="btn btn-warning" name="update">UPDATE </button>
		<br>
		<br>
		<br>
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
