...
<body>
  <button class="btn btn-warning"><a href="mainpage.php">STAFF</a></button>
<button class="btn btn-danger float-right"><a href="logout.php">LOGOUT</a></button>
 ...
 <?php  
    ...
    <tbody>
      ...
      ?></td>
    <td><a class="btn btn-info" href="staffedittree.php?edit_id=<?php echo $row['gps_id']?>" title="click for edit" onclick="return confirm('Sure to edit this record')"><span class="glyphicon glyphicone-edit"></span>Edit</a>
    </td>
