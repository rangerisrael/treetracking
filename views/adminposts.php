...
<div class="w3-white">
  ...
  <a href="user.php"class="btn logout float-right"   style="background: #5a5b59;">USER PAGE</a>
			...
			<td><a class="btn btn-info" href="admineditpost.php?edit_id=<?php echo $row['post_id']?>" title="click for edit" onclick="return confirm('Sure to edit this record')"><span class="glyphicon glyphicone-edit"></span>Edit</a></td>
...
<?php 
	...
	if(isset($_GET['delete_id']))
	{
		...
		if($stmt_delete->execute())
		{
			...
			window.location.href=('adminposts.php');
			</script>
			<?php 
		}else 
