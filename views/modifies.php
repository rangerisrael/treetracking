...
function addvoice(){
 ...
 ?></td>
                        ...
                        <td><?php echo $pwd;?><a class="btn btn-success" href="changepasswords.php?change_id=<?php echo $_SESSION['user']['id']?>" title="click for edit" onclick="return confirm('Are you sure you want to change your password?')"><span class="glyphicon glyphicone-edit"></span>CHANGE PASSWORD</a></td>
                       
                        <td><?php echo $nameofuser;?></td>
                        <td><a class="btn btn-info" href="editaccounts.php?edit_id=<?php echo $_SESSION['user']['id']?>" title="click for edit" onclick="return confirm('Sure to edit this record')"><span class="glyphicon glyphicone-edit"></span>Edit</a></td>
